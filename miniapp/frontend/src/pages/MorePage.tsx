    ...
    <div className="page-stack">
      ...
      <SectionCard title="Помощь и доступ" subtitle="Что важно знать перед показом приложения участникам">
        <ul className="flat-list">
          ...
          <li>Для стабильного полноэкранного запуска открывай VERUM через кнопку в сообщении бота.</li>
          {auth?.role === "admin" ? <li>Текущая роль аккаунта: администратор. Вкладка "Админ" доступна вместо профиля.</li> : null}
        </ul>
      </SectionCard>
    </div>
  );
